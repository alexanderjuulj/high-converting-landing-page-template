        ...
        <Box gridColumn={{ initial: "1 / -1", lg: "1 / 5" }}>
          <Flex direction="column" gap="6">
            ...
            <Text as="p" color="gray" size="3" m="0">
              This is a high converting landing page template built with Next.js
              and Radix UI. It is designed to be easy to use and customize, so
              you can get started quickly and start converting visitors into
              customers. The template is fully responsive and looks great on all
              devices.
            </Text>
            ...
            <Flex gap="4" align="center">
              <Flex>
                <Avatar size="2" variant="solid" color="indigo" fallback="Z" />
                <Avatar
                  size="2"
                  variant="solid"
                  color="cyan"
